    ...
    <div className="h-screen bg-black flex w-screen items-center justify-center relative">
      <div className="mx-auto w-fit flex flex-col items-center text-white text-4xl gap-16  z-10">
        ...
        <div className="flex flex-row gap-4">
          <div onClick={() => navigate("/free/analyzer")} className="cursor-pointer border-2 hover:bg-gray-800 border-primary-light w-fit self-center py-4 px-8 rounded-full text-white text-2xl">
            Get Started
          </div>
          <div onClick={() => navigate("/free/login")} className="cursor-pointer border-2 hover:bg-gray-800 border-blue-400 bg-blue-300 bg-opacity-25 w-fit self-center py-4 px-8 rounded-full text-white text-2xl">
            Free trial
          </div>
        </div>
      </div>
